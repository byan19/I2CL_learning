...
from peft import get_peft_model, PromptTuningConfig, LNTuningConfig, TaskType, LoraConfig
import pdb
...
class ModelWrapper(nn.Module):
    ...
    def layernorm_adaptation_verion4_basedrola(self, config, dataset, save_dir=None, run_name=None):
        ...
        pt_config = LoraConfig(r =config['lora_rank'], lora_alpha = 16, target_modules= ['lora_target_modules'], lora_dropout=  0.05, bias = "none" , task_type="CAUSAL_LM" )
