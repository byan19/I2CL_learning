...
config['exp_name'] = 'exps_restart3/Llama2_32layers_layernorm_conv1only'
config['gpus'] = ['0']
...
config['additional_layernorm_layer'] = False
config['post_attention'] = False
config['input_attention'] = True
config['conver_bound'] = True
config['ce_loss_lambda'] = 0.0
config['conver_loss_lambda'] = 1
