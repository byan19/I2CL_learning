...
config['exp_name'] = 'exps_restart/Llama2_32layers_layernorm_mulfix'
config['gpus'] = ['0']
...
config['sharpness_aware_approx'] = False
config['additional_layernorm_layer'] = True
config['post_attention'] = False
config['input_attention'] = True
config['conver_bound'] = True
config['conver_loss_lambda'] = 1e-6
config['additional_layernorm_mode'] = 'mul'
